...
SECRET_KEY = 'ij7((-#8+le*0hqzri^t(5(c(se+3*nqbvy*blmig#gw2c0#da'
...
DATABASES = {
    ...
    'default': {
        ...
        'NAME': os.environ.get("MYSQL_DB", "erp_develop"),
...
# USE_TZ = True
# 使用时区设置为False，这样数据库保存的数值就是当前时区的时机值，而不会是UTC的时间值
USE_TZ = False
